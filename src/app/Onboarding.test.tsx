...
describe('pilot onboarding', () => {
  it('keeps the legacy reviewed access form available for pilot operations', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Request pilot access' })).toBeVisible()
